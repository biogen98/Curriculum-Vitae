...
\begin{textblock}{58.5}(6,7.7)
    \begin{figure}
        \centering
        \includegraphics[width = 4cm]{profile_square_rounded.png}
    \end{figure}
    \name{Jan}{Stevens}
    \hspace{0.6cm}
    \begin{tabular}[c]{lr}
...
\section{Education}
\block{High School: Sint-Hubertus College Pelt}{Sciences and Mathematics (7 hours) | 2010 - 2016}{
\hfill
}
\newline
...
{
    Relevant Coursework: Statistical Mechanic; Introduction to Quantum Mechanics; Particle Physics;
}
\hfill
...
\block{Volunteer at Sint Oda}{Summer camp 2017}{
    Sint Oda is service centre For children and adults with severe multiple physical disabilities and a moderate to severe mental disability. During the course of the camp we helped care and animate the residents.
}
\section{Awards}

\ralewaysb Second Price \raleway junior olympiade natuurwetenschappen\hfill may 2014
\end{document}
