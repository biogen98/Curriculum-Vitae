...
{
    Relevant Coursework: Statistical Mechanics, Soft Matter Physics, 
}
...
{
    Relevant Coursework: Computational Physics, Polymer Physics, Physical Modelling of Complex Systems\\
    \textbf{Master Thesis Topic:} Simulating the Entropic Piston using oxDNA and LAMMPS
}
...
\block{Physics of Life Summer School}{Princeton Univeristy | Summer 2020}{Summer school that covered wide range of topics in Soft Matter Physics}
        
\hfill

\block{Data Science and Beyond}{Utrecht Univeristy | Summer 2020 $\rightarrow$ deffered Summer 2021}{Summer school about the science of combining data and computational models.}
...
\block{Student representative KU Leuven}{member from 2017 - current}{
    Member of the Education committee for Physics.
    %\vspace{1mm}
    %\begin{itemize}
...
\block{Board member of Student society: WINA }{member from 2017 - 2019}{
    Board member of the student society for Mathematics, Physics and CompSci. 
}

%\hfill
%
%\block{Volunteer at St-Oda}{Summer camp 2015 | St-Odafeesten 2015}{
%    Volunteered at a centre for children and adults with physical/mental disabilities.
%}

\hfill

\section{Awards}
\ralewaysb Second Price \raleway National Junior Olympiad of Natural Sciences | May 2014
